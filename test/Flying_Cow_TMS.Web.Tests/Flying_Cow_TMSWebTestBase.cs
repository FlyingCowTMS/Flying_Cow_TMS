...
{
    public abstract class Flying_Cow_TMSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Flying_Cow_TMSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Flying_Cow_TMSWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<Flying_Cow_TMSDbContext> action)
        {
            using (var context = IocManager.Resolve<Flying_Cow_TMSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<Flying_Cow_TMSDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<Flying_Cow_TMSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Flying_Cow_TMSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Flying_Cow_TMSDbContext, Task<T>> func)
        {
            T result;
