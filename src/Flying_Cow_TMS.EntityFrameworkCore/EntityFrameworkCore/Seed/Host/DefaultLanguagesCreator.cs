...
namespace Flying_Cow_TMS.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = Flying_Cow_TMSConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(Flying_Cow_TMSDbContext context)
        {
            _context = context;
        }
